...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference("Weapon.count") do
      post weapons_url, params: { weapon: { attack_points: @weapon.attack_points, name: @weapon.name } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { attack_points: @weapon.attack_points, name: @weapon.name } }
